...
import { CAROUSEL_IMAGES_750 } from "@/lib/truck-carousel-images";

export const Slide750 = () => {
  const [currentIndex, setCurrentIndex] = useState(0);
  const slideImages = CAROUSEL_IMAGES_750;
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute bottom-24 left-1/2 -translate-x-1/2 transform text-4xl text-white">
